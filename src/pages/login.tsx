        ...
        <div>
            ...
            <div className="pt-20 px-16">
                <div className={'flex py-1 border-b border-solid border-gray-900 items-center ' + style.simpleInput}>
                    ...
                    <input className="flex-grow" value={logic.email} onChange={(event) => (logic.email = event.target.value)} placeholder="请输入邮箱" />
                </div>
                <div className={'flex mt-4 py-1 border-b border-solid border-gray-900 items-center ' + style.simpleInput}>
                    ...
                    <input className="flex-grow" type="password" value={logic.password} onChange={(event) => (logic.password = event.target.value)} placeholder="请输入密码" />
                </div>
