            ...
            {logic.inManageMode ? (
                <div className="p-1 fixed bottom-0 flex items-center bg-white w-full border">
                    <div className="mr-auto text-gray-600">
                        <Checkbox checked={logic.allChecked} onChange={logic.onAllCheckClick} />
                        全选
                    </div>
                    <div className="ml-auto rounded-full border border-red-500 text-red-500 py-1 px-3 mr-1" onClick={logic.onBatchDelete}>
                        删除
                    </div>
                </div>
            ) : (
