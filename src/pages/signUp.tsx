        ...
        <div className="">
            ...
            <div className="mx-10 mt-20">
                ...
                <div className={'flex py-1 mt-2 border-b border-solid border-gray-900 items-center ' + style.simpleInput}>
                    ...
                    <input value={userName} onChange={(e) => setUserName(e.target.value)} className="flex-grow" maxLength={8} placeholder="请输入用户名" />
                </div>
                <div className={'flex py-1 mt-2 border-b border-solid border-gray-900 items-center ' + style.simpleInput}>
                ...
                <div className={'flex py-1 mt-2 border-b border-solid border-gray-900 items-center ' + style.simpleInput}>
                    ...
                    <input className="flex-grow" type="password" value={password} onChange={(e) => setpassword(e.target.value)} placeholder="请输入密码" />
                </div>
                <div className={'flex py-1 mt-2 border-b border-solid border-gray-900 items-center ' + style.simpleInput}>
                    <LockOutlined className="mr-1 text-gray-700" />
                    <input className="flex-grow" type="password" value={rePassword} onChange={(e) => setrePassword(e.target.value)} placeholder="请输入密码" />
                </div>
                <div className="flex mt-2">
                    <input className="border mr-auto" placeholder="请输入您的邮箱验证码" value={verificationCode} onChange={(e) => setverificationCode(e.target.value)} />
                    <button
                ...
                <div className="mt-4">
                    <button className="flex flex-center py-2 text-lg text-white bg-red-500 w-full" onClick={()=>{
                        const message=[];
